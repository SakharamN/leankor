...
import pom_package.CardsCreatingAndCloningInMaterContainerLocater;
...
public class CardsCreatingAndCloningInMaterContainerHelper extends CommonMethodsOfWebDriver {
	...
	public void clickOn_CreateFolderProjectKanbanBoardAndCloneCards()
	{
		...
		// following code bcoz messg not displaying
		
		explicitWaitElementToBeClickable(findElement(KanbanBoardSettingLocators.clickOnZoomIcon()));
		findElement(KanbanBoardSettingLocators.clickOnZoomIcon()).click();
	...
	public void CardsCreateOnEachMasterContainer()
	{
		...
		for(int i=1; i<=cardLimit; i++)
		{
			...
			explicitWaitVisibilityOf(findElement(CardsCreatingAndCloningInMaterContainerLocater.CategorySearchUser()));
			findElement(CardsCreatingAndCloningInMaterContainerLocater.CategorySearchUser()).sendKeys("Sales");
