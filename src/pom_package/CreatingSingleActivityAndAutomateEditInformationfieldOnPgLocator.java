...
public class CreatingSingleActivityAndAutomateEditInformationfieldOnPgLocator {
	...
	public static final By clickOnThreeDot() {
		return By.xpath("//div[text()='A "
				+ CreatingSingleActivityAndAutomateEditInformationfieldOnPgHelper.createFolderNameRandomly
				+ "']/following-sibling::div[@class='lmenu']");
	}

	public static final By clickOnCreatedProject() {
		return By.xpath("//*[contains(text(),'"
				+ CreatingSingleActivityAndAutomateEditInformationfieldOnPgHelper.createProjectNameRandomly + "')]");
	}

	public static final By clickOnPlanGantt() {
		// return
		// By.xpath("//div[contains(@id,'ext-navigationSideMenu-')]//div[contains(text(),'Plan')]);
	...
	public static final By clickOnPlusIcon() {
		return By.xpath("//div[contains(@id,'namecolumn-')]//span[@name='addButton']");// Qa5 org,QA4,qa9

		// return
		// By.xpath("//div[contains(@id,'ganttcolumn-name-')]//span[@name='addButton']");//
		// org 20,qa7,winter 25,Qa 11
	}
	...
	public static final By addActivity() {
		...
		return By.xpath(
				"//div[@class='x-menu x-layer x-menu-default x-border-box'][1]/div/div/child::div[2]/div/div[1]");
	}
	...
	public static final By writeActivityNameInputField() {
		...
		// return
		// By.xpath("//div[contains(@id,'textfield-1020-inputWrap')]/child::input");
	...
	public static final By writeActivityNameInputTextfield() {
		...
		// return By.xpath("//div[contains(@class,'x-editor x-small-editor x-grid-editor
		// x-grid-cell-editor')]//input");
	}
	...
	public static final By clickOnThreeDotOnActivityActivityAbove() {
		// return
		// By.xpath("//span[text()='Activity1']/parent::span/following-sibling::span");

		return By.xpath("//span[text()='ActivityAbove']/parent::span/following-sibling::span");

		// return
		// By.xpath("(//span[text()='ActivityAbove']/parent::span/following-sibling::span)[2]");
	}
	...
	public static final By loadmaskElemenet() {
		// return By.xpath("//div[@class='x-component x-border-box x-mask
		// x-component-default']/div/div/div[contains(@id,'loadmask-')]");
	...
	public static final By clickingOnEditInformation() {
		...
		return By.xpath(
				"//span[text()='Activity1']/ancestor::body/child::div[@class='x-menu launchBoardMenuCls x-layer x-menu-default x-border-box'][1]//span[text()='Edit Information']");

		// return
		// By.xpath("//span[text()='milestone1']/ancestor::body/child::div[@class='x-menu
		// launchBoardMenuCls x-layer x-menu-default
		// x-border-box'][1]//span[text()='Edit Information']");
	}

	public static final By clickOnActivitityAboveEditinformation() {
		return By.xpath(
				"//span[text()='ActivityAbove']/ancestor::body/child::div[@class='x-menu launchBoardMenuCls x-layer x-menu-default x-border-box'][1]//span[text()='Edit Information']");// QA11
		// return By.xpath("//div[@class='x-menu launchBoardMenuCls x-layer
		// x-menu-default x-border-box']//span[text()='Edit Information']");// Qa9

		// return By.xpath("(//div[@class='x-menu launchBoardMenuCls x-layer
		// x-menu-default x-border-box']//span[text()='Edit Information'])[2]");
	}

	public static final By clickingOnEditInformationofMilestone() {
		return By.xpath(
				"//span[text()='milestone1']/ancestor::body/child::div[@class='x-menu launchBoardMenuCls x-layer x-menu-default x-border-box'][1]//span[text()='Edit Information']");
	}
	...
	public static final By searchActivityfield() {
		return By.xpath("//input[@placeholder='Search by Name...']");// qa11 3 dot dufferences

		// return By.xpath("//input[@placeholder='Search by Name']");//qa7
	}
	...
	public static final By titleField() {
		return By.xpath(
				"//div[contains(@class,'x-window taskEditorPluginCls')]//div[@class='x-field x-form-item x-form-item-default x-form-type-text x-field-default x-anchor-form-item x-field-focus']//input[@name='Name']");
	}
	...
	public static final By OwnerSearchTrigger() {
		return By.xpath(
				"//div[contains(@class,'popupGridStyleCls')]//input[@placeholder='Search by Name...']/parent::div/following-sibling::div[2]");// qa11

		// return By.xpath("//div[contains(@class,'popupToolbarBorderCls
		// ')]//div[contains(@class,'search-trigger')]");//qa7
	...
	public static final By startDateCalendar() {
		return By.xpath(
				"//fieldset[contains(@class,'x-fieldset x-fieldset-with-title x-fieldset-with-legend')]//input[@name='StartDate']");
	}

	public static final By fetchStartDateOfActivityWhileCreating() {
		return By.xpath(
				"//div[contains(@class,'x-field x-form-field-date green-color-date-icon')]//input[@name='StartDate']");
	}

	public static final By fetchDueDateofActivityWhileCreating() {
		return By.xpath(
				"//div[contains(@class,'x-field x-form-field-date red-color-date-icon')]//input[@name='DueDate']");
	}

	public static final By dueDateCalendar() {
		return By.xpath(
				"//fieldset[contains(@class,'x-fieldset x-fieldset-with-title x-fieldset-with-legend')]//input[@name='DueDate']");
	}

	public static final By durationfieldforActivityInfo() {
		// return By.xpath("//div[contains(@class,'x-field
		// durationFieldCls')]//input[@name='EstimatedDuration']");

		return By.xpath(
				"//div[contains(@class,'x-field durationFldcls x-form-item x-form-item-default x-form-type-text x-box-item x-field-default x-hbox-form-item')]//input[@name='EstimatedDuration']");

	}

	/*
	 * public static final By editPopSaveButton() { //return
	 * By.xpath("//a[contains(@class,'editPopUpSaveBtn ')]");
	 *
	 * return By.
	 * xpath("//div[contains(@class,'taskEditorPluginCls ')]//a[contains(@class,'editPopUpSaveBtn ')]"
	 * ); }
	 */
	...
	public static final By clickOn_ActivityInfo() {
		return By.xpath(
				"//div[@class='x-panel x-fit-item x-window-item x-panel-default']//span[text()='Activity Info']");
	}
	...
	public static final By clickOn_Status() {
		// return By.xpath("//div[@class='x-panel x-fit-item x-window-item
		// x-panel-default']//span[text()='Status']");

		return By.xpath("(//div[@class='x-panel x-fit-item x-window-item x-panel-default']//span[text()='Status'])[1]");
	}

	public static final By onTime_dropdown() {
		return By.xpath(
				"//div[@class='x-panel cardStatusFormCls x-tabpanel-child x-panel-default']/div/div/div/div/child::div[2]//a[1]");
	}

	public static final By onQuality_dropdown() {
		return By.xpath(
				"//div[@class='x-panel cardStatusFormCls x-tabpanel-child x-panel-default']/div/div/div/div/child::div[2]//a[2]");
	}

	public static final By onBudget_dropdown() {
		return By.xpath(
				"//div[@class='x-panel cardStatusFormCls x-tabpanel-child x-panel-default']/div/div/div/div/child::div[2]//a[3]");
	}
	...
	public static final By statusRegisterDateVerify() {
		// return By.xpath("//div[@class='customStatusCls
		// x-item-selected']/table/tbody/tr/td[1]/p");
		// return
		// By.xpath("//div[contains(@class,'customStatusCls')]/table/tbody/tr/td[1]/p");
		// return
		// By.xpath("//div[contains(@class,'subscriberListC')]/div/table/tbody/tr/td[1]/p");
	...
	public static final By verifyStatusRegisterDescription() {
		// return
		// By.xpath("//div[contains(@class,'subscriberListC')]/div/table/tbody/tr/td[2]/p");
	...
	public static final By clickOn_logTime() {
		return By.xpath(
				"(//div[@class='x-panel x-fit-item x-window-item x-panel-default']//span[text()='Log Time'])[1]");
	}

	public static final By clickOnDatefieldforlogtime() {
		// return By.xpath("//input[@name='LogTime']");
		return By.xpath(
				"//div[contains(@class,'x-field x-form-field-date green-color-date-icon ')]//input[@name='LogTime']");
	...
	public static final By searchIconOnLogTime() {
		// return By.xpath("//div[@class='x-form-trigger x-form-trigger-default
		// x-form-search-trigger x-form-search-trigger-default ']");
	...
	public static final By clickOnLogTimeAddButton() {
		// return By.xpath("//a[contains(@class,'addStatusLogBtn
		// ')]//span[text()='Add']");//qa5
		// return By.xpath("//div[contains(@class,'statusTabpanelCls
		// ')][2]/div/child::div[2]//a//span[text()='Add']");//spring24

		return By.xpath(
				"//div[contains(@id,'logtimeinformation-')]//a[contains(@class,'addStatusLogBtn ')]//span[text()='Add']");
	}
	...
	public static final By getLogTimeDate() {
		return By.xpath(
				"//div[@class='x-panel x-tabpanel-child x-panel-default']//div[contains(@class,'x-dataview-item')]/table/tbody/tr/td[2]");
	}

	public static final By getLogTimeHrs() {
		return By.xpath(
				"//div[@class='x-panel x-tabpanel-child x-panel-default']//div[contains(@class,'x-dataview-item')]/table/tbody/tr/td[3]");
	}

	public static final By getLogTimeDescription() {
		return By.xpath(
				"//div[@class='x-panel x-tabpanel-child x-panel-default']//div[contains(@class,'x-dataview-item')]/table/tbody/tr/td[4]");
	}

	public static final By clickOnEditLogTime() {
		return By.xpath(
				"//div[@class='x-panel x-tabpanel-child x-panel-default']//div[contains(@class,'x-dataview-item')]/table/tbody/tr/td[5]");
	}

	public static final By clickOnDeleteLogTime() {
		return By.xpath(
				"//div[@class='x-panel x-tabpanel-child x-panel-default']//div[contains(@class,'x-dataview-item')]/table/tbody/tr/td[6]");
	}
	...
	public static final By selectDatefromDatePicker() {
		// return By.xpath("//div[@class='x-datepicker x-layer x-datepicker-default
		// x-unselectable x-border-box x-datepicker-above']//tr[5]/td[5]");
		// return By.xpath("//div[@class='x-datepicker x-layer x-datepicker-default
		// x-unselectable x-border-box']//tr[5]/td[5]");
		return By.xpath(
				"//table[@class='x-datepicker-inner x-focus x-datepicker-focus x-datepicker-default-focus']//tr[4]/td[4]");
	...
	public static final By clickOnEditLogTimeSpinnerUp() {
		return By.xpath(
				"//div[contains(@id,'logtimeeditformpanel-')]//input[@name='Estimation']/parent::div/following-sibling::div/child::div[1]");
	}
	...
	public static final By selectDurationValue() {
		...
		// return By.xpath("//div[@class='x-boundlist x-boundlist-floating x-layer
		// x-boundlist-default x-border-box' and @style='width: 203px; left: 1625px;
		// top: 229px; height: auto; z-index: 99000;']/div/ul/li[text()='Days']");
	...
	public static final By clickOnRiskTab() {
		return By.xpath(
				"//div[@class='x-panel x-fit-item x-window-item x-panel-default']/div/div/div/div/div/child::a[4]");
	}
	...
	public static final By selectValuefromWeightHowImportantDropdown() {
		// return By.xpath("//div[@class='x-boundlist x-boundlist-floating x-layer
		// x-boundlist-default x-border-box']//li[text()='Very Important']");
	...
	public static final By selectValuefromProbabilityHowLikelyDropdown() {
		// return By.xpath("//div[@class='x-boundlist x-boundlist-floating x-layer
		// x-boundlist-default x-border-box']//li[text()='Very Likely']");
	...
	public static final By clickOnDatefieldofRisk() {
		return By.xpath(
				"//div[@class='x-panel radiofieldCls x-panel-default']/following-sibling::div[3]//input[@name='LogTime']");
	}

	public static final By clickOnTodayDate() {
		return By.xpath(
				"//div[@class='x-datepicker x-layer x-datepicker-default x-unselectable x-border-box x-datepicker-above']//span[text()='Today']");
	}

	public static final By clickOnAddRiskButton() {
		return By.xpath(
				"//div[@class='x-panel radiofieldCls x-panel-default']/following-sibling::div[3]/div/div/div/div/a");
	}

	public static final By riskIssueAddedMsg() {
		return By.xpath(
				"//div[@class='x-panel radiofieldCls x-panel-default']/following-sibling::div[3]/div/div/div/div/div[3]//div[@class='riskIssueAdded']");
	}
	...
	public static final By clickOnAtriskCheckbox() {
		return By.xpath(
				"//div[@class='x-panel statusTabpanelCls x-tabpanel-child x-panel-default']/div/child::div[3]/div");
	}

	public static final By verifyResolvedCheckboxAfterAddedRiskOnActivity() {
		// return By.xpath("//div[@class='x-panel statusTabpanelCls x-tabpanel-child
		// x-panel-default']//div[@class='x-dataview-item']/table/tbody/tr/td[1]");
		return By.xpath(
				"//div[@class='x-panel statusTabpanelCls x-tabpanel-child x-panel-default']//div[@class='x-dataview-item']/table/tbody/tr/td[1]/span");
	}

	public static final By getDateofriskRegistertab() {
		return By.xpath(
				"//div[@class='x-panel statusTabpanelCls x-tabpanel-child x-panel-default']//div[@class='x-dataview-item']/table/tbody/tr/td[2]");
	}

	public static final By getRiskScoreofActivity() {
		return By.xpath(
				"//div[@class='x-panel statusTabpanelCls x-tabpanel-child x-panel-default']//div[@class='x-dataview-item']/table/tbody/tr/td[3]");
	}

	public static final By verifyRiskType() {
		return By.xpath(
				"//div[@class='x-panel statusTabpanelCls x-tabpanel-child x-panel-default']//div[@class='x-dataview-item']/table/tbody/tr/td[4]");
	}

	public static final By getDetailDescriptionofRisk() {
		return By.xpath(
				"//div[@class='x-panel statusTabpanelCls x-tabpanel-child x-panel-default']//div[@class='x-dataview-item']/table/tbody/tr/td[5]");
	}

	public static final By clickOnEditRisk() {
		return By.xpath(
				"//div[@class='x-panel statusTabpanelCls x-tabpanel-child x-panel-default']//div[@class='x-dataview-item']/table/tbody/tr/td[6]");
	}

	public static final By clickOnDeleteRiskButton() {
		return By.xpath(
				"//div[@class='x-panel statusTabpanelCls x-tabpanel-child x-panel-default']//div[@class='x-dataview-item']/table/tbody/tr/td[7]");
	}
	...
	public static final By clickOnWeightHowImportantDropdownforEditRisk() {
		// return By.xpath("//div[contains(@class,'popupToolbarBorderCls
		// ')][2]//div[@style='padding:10px 10px 10px
		// 10px']/div[1]//input[@name='Weight']/parent::div/following-sibling::div");
		return By.xpath(
				"//div[contains(@class,'popupToolbarBorderCls ')]//input[@name='Weight']/parent::div/following-sibling::div");
	}

	public static final By clickOnProbabilityHowLikelyDropdownforEditRisk() {
		// return By.xpath("//div[contains(@class,'popupToolbarBorderCls
		// ')][2]//div[@style='padding:10px 10px 10px
		// 10px']/div[1]//input[@name='Probability']/parent::div/following-sibling::div");
		return By.xpath(
				"//div[contains(@class,'popupToolbarBorderCls ')]//input[@name='Probability']/parent::div/following-sibling::div");
	}

	public static final By selectValuefromHowImportantDropdown() {
		// return By.xpath("//div[contains(@class,'x-boundlist x-boundlist-floating
		// ')][6]/div/ul/li[3]");
	...
	public static final By clickOnTodayDateOnResolvedDate() {
		return By.xpath(
				"//div[contains(@class,'x-datepicker x-layer x-datepicker-default')][3]//div[@class='x-datepicker-footer']/a");
	}

	public static final By clickOnTodayDateEditRiskOnActivity() {
		return By.xpath(
				"//div[contains(@class,'popupToolbarBorderCls ')]/following-sibling::div[3]//table/following-sibling::div/a//span[text()='Today']");
	}
	...
	public static final By clickOnSubscriberTab() {
		return By.xpath(
				"//div[@class='x-panel x-fit-item x-window-item x-panel-default']/div/div/div/div/div/child::a[5]");
	...
	public static final By clickOnSubscriberSearchIcon() {
		return By.xpath(
				"//div[contains(@class,'popupGridStyleCls ')]//input[@placeholder='Search for user']/parent::div/following-sibling::div[2]");
	}
	...
	public static final By notifyPercentageCompleteDoneCheckbox() {
		// return By.xpath("//div[contains(@class,'x-field
		// prority_lbl_white_Subscriber')]/following-sibling::div[1]//input[@type='checkbox']");
		// return By.xpath("//div[contains(@class,'x-field subscribersCheckBoxCls
		// ')][1]");

		return By.xpath(
				"//div[contains(@id,'subscribersinformation-')]//div[contains(@class,'x-field subscribersCheckBoxCls ')][1]");
	...
	public static final By notifyActivityPastDueDate() {
		...
		return By.xpath(
				"//div[contains(@id,'subscribersinformation-')]//div[contains(@class,'x-field subscribersCheckBoxCls ')][2]");
	}
	...
	public static final By clickSubscriberEditIcon() {
		// return By.xpath("//div[contains(@class,'subscriberListCls
		// ')]//tr/td[4]/div");
		return By.xpath(
				"//div[contains(@id,'subscribersinformation-')]//div[contains(@class,'subscriberListCls ')]//tr/td[4]/div");
	}
	...
	public static final By chooseNoOptionOnDeleteSubscriberPopUp() {
		return By.xpath(
				"//div[text()='Delete Subscriber']/ancestor::div[contains(@class,'x-window x-message-box x-layer')]//a[3]");
	}
	...
	public static final By editPercentageCompleteDoneCheckbox() {
		return By.xpath(
				"//div[contains(@class,'x-window popupToolbarBorderCls')]//div[contains(@class,'subscribersCheckBoxCls ')][1]");
	}

	public static final By editActivityPastDueDate() {
		return By.xpath(
				"//div[contains(@class,'x-window popupToolbarBorderCls')]//div[contains(@class,'subscribersCheckBoxCls ')][2]");
	}

	public static final By clickOnUpdateSubscriber() {
		return By.xpath(
				"//div[contains(@class,'x-window popupToolbarBorderCls')]//a[contains(@class,'editPopUpSaveBtn ')]");
	}
	...
	public static final By clickOnResourceTab() {
		return By.xpath(
				"//div[@class='x-panel x-fit-item x-window-item x-panel-default']/div/div/div/div/div/child::a[7]");
	}

	public static final By clickOnAllDropdown() {
		return By.xpath(
				"//div[@class='x-panel gnt-assignmentgrid x-tabpanel-child x-panel-default x-grid']/div/div[1]//input[@value='All']");
	}

	public static final By chooseAllvalue() {
		// return By.xpath("//div[@class='x-boundlist x-boundlist-floating x-layer
		// x-boundlist-default x-border-box'][5]//ul/li[1]");
		return By.xpath("//ul[@class='x-list-plain']/li[text()='All']");
	}

	public static final By clickOnAddResourcebutton() {
		return By.xpath(
				"//div[@class='x-panel gnt-assignmentgrid x-tabpanel-child x-panel-default x-grid']/div/div[2]//a[1]");// winter
																														// 25
		// return By.xpath("//div[@class='x-panel x-tabpanel-child
		// x-panel-default']//span[text()='Add']");// SUMMER 24
	}
	...
	public static final By chooseResourceOptions() {
		...
		// return By.xpath("//div[contains(@class,'taskEditorPluginCls
		// ')]//label[text()='Resource']");//summer24
	}

	public static final By doubleclickOnResourcenameColumn() {
		// return By.xpath("//div[@class='x-grid-item-container' and @style='width:
		// 548px; transform: translate3d(0px, 0px, 0px);']//tr/td[2]");

		return By.xpath("//div[@class='x-grid-item-container' ]//tr/td[contains(@class,'resourcenamecolumn-')]");

		// return By.xpath("//input[@placeholder='Select Leankor
		// Resources']");//summer24
	}
	...
	public static final By selectSecondResourceforFixDuration() {
		return By.xpath("//span[text()='PRATISH LAAD']");
	}

	public static final By filterResourcesInputfield() {
		// return By.xpath("//div[@class='x-panel gnt-assignmentgrid x-tabpanel-child
		// x-panel-default x-grid']/div/div[1]//input[@placeholder='Filter
		// Resources']");
	...
	public static final By searchIconfilterResource() {
		return By.xpath(
				"//div[contains(@class,'taskEditorPluginCls ')]//input[@placeholder='Filter Resources']/parent::div/following-sibling::div[2]");
	}

	public static final By selectOnfilteredResourceIMG() {
		// return By.xpath("//div[@class='x-grid-item-container' and @style='width:
		// 548px; transform: translate3d(0px, 0px,
		// 0px);']//tr/td[2]/div[text()='sakharam Nilkhan']");

		// return By.xpath("//div[@class='x-grid-item-container' and @style='width:
		// 548px; transform: translate3d(0px, 0px, 0px);']//tr/td[1]");
		// return By.xpath("//div[contains(@class,'x-grid-view x-grid-with-row-lines
		// ')]//div[@class='x-grid-item-container'
		// ]//tr/td[contains(@class,'ownerColumn')]");

		return By.xpath(
				"//div[contains(@class,'x-grid-view x-grid-with-row-lines ')]//div[@class='x-grid-item-container' ]//tr/td[contains(@class,'ownerColumn')]");
	}

	public static final By clickOnRemoveResource() {
		return By.xpath(
				"//div[@class='x-panel gnt-assignmentgrid x-tabpanel-child x-panel-default x-grid']/div/div[2]//a[2]");

		// return By.xpath("//div[contains(@class,'subscriberListCls
		// ')]//div[@class='deleteLog']");
		// return
		// By.xpath("//div[contains(@id,'resourceassignmentinformation-')]//div[contains(@class,'subscriberListCls
		// ')]//div[@class='deleteLog']");
	}

	public static final By chooseYesOptionOnDeleteResource() {
		return By.xpath(
				"//div[text()='Delete Resource ?']/ancestor::div[@class='x-window-bodyWrap']/child::div[2]//a[2]");
	}
	...
	public static final By verifyResource() {
		...
		// 548px; transform: translate3d(0px, 0px, 0px);']//tr/td[1]");
		// return By.xpath("//div[@class='x-grid-item-container' and @style='width:
		// 548px; transform: translate3d(0px, 0px, 0px);']//tr/td[1]/div/img");
		return By.xpath(
				"//div[contains(@class,'x-grid-view x-grid-with-row-lines ')]//div[@class='x-grid-item-container' ]//tr/td[contains(@class,'ownerColumn')]");
	...
	public static final By verifyAllocation() {
		// return By.xpath("//div[@class='x-grid-item-container' and @style='width:
		// 548px; transform: translate3d(0px, 0px, 0px);']//tr/td[3]/div");
		return By.xpath(
				"//div[contains(@class,'x-grid-view x-grid-with-row-lines ')]//div[@class='x-grid-item-container' ]//tr/td[contains(@class,'assignmentunitscolumn-')]");
	...
	public static final By clickOn_activityMode()// for activity mode and milestone mode same xpath
	{
		return By.xpath(
				"//div[@class='x-panel x-fit-item x-window-item x-panel-default']/div/div/div/div/div/child::a[8]");
	}

	public static final By clickOn_ActivitySchedulingModeDropdown() {
		// return
		// By.xpath("//div[contains(@id,'activitymodeinformation-')]/table/tbody/tr[1]/td/div[1]/div/div/child::div[2]");

		return By.xpath(
				"//div[contains(@id,'activitymodeinformation-')]//label[contains(@id,'schedulingmodefield-')]/following-sibling::div");
	}

	public static final By actualEffortInputTextfield() {
		// return
		// By.xpath("//div[contains(@id,'activitymodeinformation-')]/table/tbody/tr[2]/td/div[1]/div/div/child::div/input");
		// return
		// By.xpath("//table[contains(@id,'activitymodeinformation-')]//input[@name='Effort']");

		return By.xpath(
				"//div[contains(@id,'activitymodeinformation-')]//div[contains(@id,'effortfield-')]//input[@name='Effort']");

	}

	public static final By getActuatEffortField() {
		// return By.xpath("//div[contains(@class,'activityModeFormCls
		// ')]//div[@class='x-field x-form-item x-form-item-default x-form-type-text
		// x-field-default x-table-form-item x-form-dirty']/div");
		return By.xpath(
				"//div[contains(@class,'activityModeFormCls ')]//div[@class='x-field x-form-item x-form-item-default x-form-type-text x-field-default x-table-form-item x-form-dirty']//input");
	}

	public static final By clickOnConstraintTypeDropdown() {
		return By.xpath(
				"//div[contains(@id,'activitymodeinformation-')]/table/tbody/tr[3]/td/div[1]/div/div/child::div[2]");
	}

	public static final By clickOnConstraintDateCalendar() {
		return By.xpath(
				"//div[contains(@id,'activitymodeinformation-')]/table/tbody/tr[4]/td/div[1]/div/div/child::div[2]");
	}

	public static final By clickOnManuallyScheduleCheckbox() {
		return By.xpath(
				"//div[contains(@id,'activitymodeinformation-')]/table/tbody/tr[5]/td/div[1]/div/div/span/input");
	}
	...
	public static final By activityDurationforNormalMode() {
		// return By.xpath("//div[contains(@class,'x-field
		// durationFieldCls')]//input[@name='EstimatedDuration']/parent::div/following-sibling::div");
		return By.xpath("//input[@name='EstimatedDuration']");
	}

	public static final By loadSpinnerofAddingActivity() {
		return By.xpath(
				"//div[@class='x-window taskEditorPluginCls gnt-taskeditor-window gnt-projecteditor-window x-layer x-window-default x-closable x-window-closable x-window-default-closable x-border-box x-masked']//div[@class='x-mask-loading x-mask-msg-inner ']//div[contains(@id,'loadmask-')]");
	}
	...
	public static final By durationfieldforActivityInfoTrigger() {
		// return By.xpath("//div[contains(@class,'x-field durationFldcls x-form-item
		// x-form-item-default x-form-type-text x-box-item x-field-default
		// x-hbox-form-item')]//div[@class='x-form-trigger-wrap
		// x-form-trigger-wrap-default']/child::div[2]");
	...
	public static final By clickOn_NavIconScroller() {
		return By.xpath(
				"//div[@class='x-unsized x-button menu x-dock-item x-docked-right x-has-height x-iconalign-center']");
	}

	public static final By clickOn_ThreeDotOnProjectBoards() {
		// return By.xpath("//div[@class='x-inner x-scroll-scroller-vertical
		// x-scroll-scroller']//div[@title='Project
		// Boards']/following-sibling::div[2]");
	...
	public static final By clickOn_OpenCreatedKBboard() {
		...
		// return By.xpath("//div[@class='innerclass contentseprator
		// ']//div[text()='kanban1']");
	...
	public static final By clickOn_files() {
		return By.xpath(
				"//div[@class='x-panel x-fit-item x-window-item x-panel-default']/div/div/div/div/div/child::a[10]");
	}

	public static final By salesForceFileUploadTab() {
		return By.xpath(
				"//div[contains(@class,'x-panel fileconnect-tabpanel-cls x-box-item x-panel-default')]//span[text()='Salesforce Files Upload']");
	}
	...
	public static final By editPopUpSaveButton() {
		return By.xpath(
				"//div[contains(@class,'taskEditorPluginCls ')]//a[contains(@class,'editPopUpSaveBtn ')]//span[text()='Save']");
	}

	public static final By clickOnAppLauncher() {
		return By.xpath(
				"//div[@class='dragArea slds-app-launcher__tile slds-text-link_reset slds-is-draggable inner-card uiDraggable']//a[text()='Leankor App']");
	}
	...
	public static final By waitAfterUploadButtonClick() {
		return By.xpath(
				"//div[contains(@id,'ext-fileDataView-')]//div[contains(@id,'ext-loadmask-')]//div[@class='x-loading-spinner-outer']");
	}

	public static final By clickOnEditCardFinalSaveButton() {
		return By.xpath("//div[contains(@class,'taskEditorPluginCls ')]//span[text()='Save']");
	...
	public static final By planGanttZoomToFit() {
		...
		return By.xpath(
				"//div[contains(@class,'x-boundlist x-boundlist-floating')]/div/ul/ul[@class='x-list-plain']/li[1]");
	}
