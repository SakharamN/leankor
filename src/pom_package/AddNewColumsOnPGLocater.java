...
public class AddNewColumsOnPGLocater {
	...
	public static final By clickOnThreeDots() {
		return By.xpath("//div[text()='A " + AddNewColumsOnPGHelper.createFolderNameRandomly
	...
	public static final By addNewColumnsAllPopUpElementsSize() {
		...
		// return By.xpath("//div[@class='x-menu x-layer x-menu-default
		// x-border-box']//span");//summer24
	}

	public static final By dividerBar() {
		return By.xpath(
				"//div[contains(@class,'customGanttPanelCls ')]//div[contains(@class,'x-splitter sch-timelinepanel-splitter x-border-item x-box-item x-splitter-default x-splitter')]");
	}
	...
	public static final By triggerofPercentageDoneColumn() {
		return By.xpath(
				"//div[contains(@id,'headercontainer-')]//span[text()='% Done']/parent::div/parent::div/parent::div/following-sibling::div");
	}
	...
	public static final By triggerofAssignedResourceColumn() {
		return By.xpath(
				"//div[contains(@id,'headercontainer-')]//span[text()='Assigned Resources']/parent::div/parent::div/parent::div/following-sibling::div");
	}
	...
	public static final By triggerofCategoryColumn() {
		return By.xpath(
				"//div[contains(@id,'headercontainer-')]//span[text()='Category']/parent::div/parent::div/parent::div/following-sibling::div");
	}
	...
	public static final By triggerofDescriptionColumn() {
		return By.xpath(
				"//div[contains(@id,'headercontainer-')]//span[text()='Description']/parent::div/parent::div/parent::div/following-sibling::div");
	}
	...
	public static final By triggerofDiscussColumn() {
		return By.xpath(
				"//div[contains(@id,'headercontainer-')]//span[text()='Discuss']/parent::div/parent::div/parent::div/following-sibling::div");
	}
	...
	public static final By triggerofElapsedTimeColumn() {
		return By.xpath(
				"//div[contains(@id,'headercontainer-')]//span[text()='Elapsed Time']/parent::div/parent::div/parent::div/following-sibling::div");
	}
	...
	public static final By triggerofFilesColumn() {
		return By.xpath(
				"//div[contains(@id,'headercontainer-')]//span[text()='Files']/parent::div/parent::div/parent::div/following-sibling::div");
	}
	...
	public static final By triggerofOnHoldColumn() {
		return By.xpath(
				"//div[contains(@id,'headercontainer-')]//span[text()='On Hold']/parent::div/parent::div/parent::div/following-sibling::div");
	}
	...
	public static final By triggerofPredecessorColumn() {
		return By.xpath(
				"//div[contains(@id,'headercontainer-')]//span[text()='Predecessors']/parent::div/parent::div/parent::div/following-sibling::div");
	}
	...
	public static final By triggerofPriorityColumn() {
		return By.xpath(
				"//div[contains(@id,'headercontainer-')]//span[text()='Priority']/parent::div/parent::div/parent::div/following-sibling::div");
	}
	...
	public static final By triggerofRiskColumn() {
		return By.xpath(
				"//div[contains(@id,'headercontainer-')]//span[text()='Risk']/parent::div/parent::div/parent::div/following-sibling::div");
	}
	...
	public static final By triggerofSequenceColumn() {
		return By.xpath(
				"//div[contains(@id,'headercontainer-')]//span[text()='Sequence']/parent::div/parent::div/parent::div/following-sibling::div");
	}
	...
	public static final By triggerofStickersColumn() {
		return By.xpath(
				"//div[contains(@id,'headercontainer-')]//span[text()='Stickers']/parent::div/parent::div/parent::div/following-sibling::div");
	}
	...
	public static final By triggerofSuccessorColumn() {
		return By.xpath(
				"//div[contains(@id,'headercontainer-')]//span[text()='Successors']/parent::div/parent::div/parent::div/following-sibling::div");
	}
	...
	public static final By triggerofTimeToLaunchColumn() {
		return By.xpath(
				"//div[contains(@id,'headercontainer-')]//span[text()='Time To Launch']/parent::div/parent::div/parent::div/following-sibling::div");
	}

	public static final By ClickOnRemoveColumn() {
		return By.xpath(
				"//div[@class='x-box-inner x-box-scroller-body-vertical x-scroller']//div//span[text()='Remove Column'][position()<2]");
