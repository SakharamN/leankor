...
public class CreatingSingleActivityAndAutomateEditInformationfieldOnPgLocator {
   ...
   {
	  // return By.xpath("//div[@class='x-menu x-layer x-menu-default x-border-box'][1]//span[text()='Resource']");
   ...
   {
	   return By.xpath("//div[@class='x-panel gnt-assignmentgrid x-tabpanel-child x-panel-default x-grid']/div/div[1]//input[@placeholder='Filter Resources']/parent::div/following-sibling::div[2]");
   }
