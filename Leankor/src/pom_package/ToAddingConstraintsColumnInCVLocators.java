...
public static final By MoveOnCardDetailsfirstcolumns()
{
	...
	return By.xpath("//div[contains(@class,'x-panel x-grid-inner-locked x-border-item x-box-item x-panel-default x-tree-panel x-tree-arrows x-grid')]//div[contains(@class,'x-column-header x-column-header-align-left x-box-item x-column-header-default x-unselectable x-column-header-first')]");
}
