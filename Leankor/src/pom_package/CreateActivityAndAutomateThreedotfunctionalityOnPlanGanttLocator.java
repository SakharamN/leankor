...
public class CreateActivityAndAutomateThreedotfunctionalityOnPlanGanttLocator {
	...
	public static final By iFrameSrcValueAndSwitchToframe()
	{
	   // return By.xpath("//iframe[@src='"+CreateCardsOnDifferentMasterContainersOnCVHelper.getIframeSRCAttribute+"']");
		...
		return By.xpath("//iframe[@src='"+CreateActivityAndAutomateThreedotfunctionalityOnPlanGanttHelper.getIframeSRCAttribute+"']");
	}
	
	
	public static final By getChildiFrameClassAttributeValue()
	{
		return By.xpath("//iframe[@class='"+CreateActivityAndAutomateThreedotfunctionalityOnPlanGanttHelper.childIframevalue+"']");
	}
	...
	{
		return By.xpath("//div[@id='chatterexpando']//div[@id='feedwrapper']//div[@id='"+CreateActivityAndAutomateThreedotfunctionalityOnPlanGanttHelper.textAreaIDAttribute+"']//div[@class='cxfeeditemtextwrapper']//p");
	}
