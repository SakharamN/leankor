...
public class AddKanbanCardRegressionOnCalendarViewLocater {
	...
	{
		//return By.xpath("//table[contains(@id,'combobox-1137-triggerWrap')]//tbody/tr/td[2]/div");
	...
	}//div[@id='ext-comp-1009-normal']/div[2]/div/table/tbody/tr[3]/td/div
	...
	{
		//return By.xpath("//table[contains(@id,'percentfield-1121-triggerWrap')]//div[contains(@class,'x-trigger-index-0 x-form-trigger x-form-spinner-up')]");
	...
	public static final By SaveCard()
	{
		...
		return By.xpath("//div[@class='x-window gnt-taskeditor-window x-layer x-window-default x-closable x-window-closable x-window-default-closable x-border-box']//span[text()='Save']");
	}
	...
	{
		//return By.xpath("//table[contains(@id,'effortfield-1170')]/tbody/tr/td[2]/div[contains(@id,'ext-gen3894')]");
		//return By.xpath("//div[@id='effortfield-1159-trigger-spinner']/div[1]");
	...
	{
		//return By.xpath("//div[@style='width: 300px; height: 170px; right: auto; left: 288px; top: 356px; z-index: 19001;']//span[@style='display: table; width: 100%; table-layout: fixed; height: 100%;']//table/tbody/tr/td[contains(@id,'checkbox-1687-labelCell')]");
		//return By.xpath("//div[@class='x-window x-layer x-window-default x-closable x-window-closable x-window-default-closable x-border-box x-resizable x-window-resizable x-window-default-resizable']//div[contains(@class,'x-window-body x-window-body-default x-closable')]//table/tbody/tr/td[contains(@id,'checkbox-1666-labelCell')]");
	...
	{
		return By.xpath("//table[contains(@class,'x-datepicker-inner x-focus x-datepicker-focus x-datepicker-default-focus')]//td[contains(@class,'x-datepicker-active x-datepicker-today x-datepicker-cell x-datepicker-selected')]/parent::tr/child::td/parent::tr/following::tr/td[3]");
	}
	...
	*/
	...
	{
		return By.xpath("//div[contains(@class,'x-component subscriberListCls x-window-item x-component-default')]/div/table/tbody/tr/td[3]/div[@class='chatterIcon']");
	}
	
	public static final By DeleteOnEDitTask()
	{
		return By.xpath("//div[contains(@class,'x-component subscriberListCls x-window-item x-component-default')]/div/table/tbody/tr/td[4]/div[@title='Delete Task']");
	}
	...
	{
		return By.xpath("//div[@class='x-menu-bodyWrap']//span[text()='Files']/parent::a");
	}
