...
public class AddMilestoneOnMasterContainerInCVLocator 
{
	...
	{
		//return By.xpath("//div[contains(@style,'width: 240px; right: auto; left: 4px; top: 75px;')]//span[text()='Delete']");
		return By.xpath("//div[contains(@style,'width: 240px; left: 4px; top: 74px;')]/div/div/a[2]");
	}
	...
	{
		return By.xpath("//span[contains(text(),'In Progress')]/ancestor::table/following-sibling::table[3]");
	}
