...
public class KanbanBoardRegressionHelper extends CommonMethodsOfWebDriver {
	...
	public void creatingSingleKanbanCard()
	{
		...
		/*
		 * 
		 * //try {Thread.sleep(2000);}catch(InterruptedException ie) {} WebElement eleme
		 * =driver.findElement(By.
		 * xpath("//div[@class='headParent']/child::div[text()='ALL FOLDERS']/following-sibling::div"
		 * ));
		 * 
	...
	public void clickOn_QuickActionOnKanbanCard()
	{
		...
		if(classAttributeValueOfQuickActionSideColumn.equals("aParent "))		//Class attribute is aParent means Quick Action icon is visible and click on it
		{
