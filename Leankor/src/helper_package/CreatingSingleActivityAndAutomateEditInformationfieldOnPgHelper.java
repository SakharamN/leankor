...
public class CreatingSingleActivityAndAutomateEditInformationfieldOnPgHelper extends CommonMethodsOfWebDriver {
  ...
  public void Create_SingleActivity()
  {
	 ...
	 //   try {Thread.sleep(1000);}catch(InterruptedException ie) {}
	    ...
	    explicitWaitElementToBeClickable(findElement(CreatingSingleActivityAndAutomateEditInformationfieldOnPgLocator.clickOnThreeDot()));
	   ...
	   // try {Thread.sleep(4000);}catch(InterruptedException ie) {}
	    ...
	    explicitWaitVisibilityOf(findElement(CreatingSingleActivityAndAutomateEditInformationfieldOnPgLocator.clickOnCreatedProject()));
	   ...
	   // findElement(CreatingSingleActivityAndAutomateEditInformationfieldOnPgLocator.addActivity()).click();
    	...
    	//folowing code commit for adding stickers
    	/*
	  ...
	  //	 findElement(CreatingSingleActivityAndAutomateEditInformationfieldOnPgLocator.descriptionfield()).sendKeys("activity1");
	 	 ...
	 	 explicitWaitVisibilityOf(findElement(CreatingSingleActivityAndAutomateEditInformationfieldOnPgLocator.descriptionfield()));
	  	 ...
	  	 findElement(CreatingSingleActivityAndAutomateEditInformationfieldOnPgLocator.descriptionfield()).sendKeys("This is activity description");
		...
		public void editLogTime()
	  	{
	  		...
	  		findElement(CreatingSingleActivityAndAutomateEditInformationfieldOnPgLocator.searchForUser()).sendKeys("Sakharam Nilkhan");
		...
		public void clickOn_RiskTab()
		{
           ...
           // following code for edit the risk register tab 
	    	...
	    	public void clickOn_SubscriberTab()
	    	{
	    		...
	    		findElement(CreatingSingleActivityAndAutomateEditInformationfieldOnPgLocator.searchUserSubscriberInputfield()).sendKeys("Sakharam Nilkhan");
	    	...
	    	//following code for resource column
	      	...
	      	public void clickOn_ResourceTabOnActivity()
	      	{
	      		...
	      		findElement(CreatingSingleActivityAndAutomateEditInformationfieldOnPgLocator.searchResourceInputfield()).sendKeys("Sakharam Nilkhan");
	      		...
	      		actions.moveToElement(findElement(CreatingSingleActivityAndAutomateEditInformationfieldOnPgLocator.clickOnRemoveResource())).click().build().perform();
