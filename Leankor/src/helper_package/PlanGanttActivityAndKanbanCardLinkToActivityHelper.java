	...
	public void clickOnPlanGantt()
	{
		...
		//  <!--Your coment-->   This is ued for comment the code for xml file 
			...
			if(i>=6)
			{
				...
				actions.moveToElement(findElement(By.xpath("//form[@id='ext-zonePanel-32']//div[@id='ext-kanbandataview-2']/div["+i+"]//div[@class='kanbancard ']/div[2]/div[2]/ul/li[7]"))).build().perform();
				explicitWaitElementToBeClickable(findElement(By.xpath("//form[@id='ext-zonePanel-32']//div[@id='ext-kanbandataview-2']/div["+i+"]//div[@class='kanbancard ']/div[2]/div[2]/ul/li[7]")));
				...
				findElement(By.xpath("//form[@id='ext-zonePanel-32']//div[@id='ext-kanbandataview-2']/div[\"+i+\"]//div[@class='kanbancard ']/div[2]/div[2]/ul/li[7]")).click();
		...
		for(int k=21; k<=25; k++)
		{
			...
			if(k>=26)
			{
				...
				try {Thread.sleep(2000);}catch(InterruptedException ie) {}
				actions.moveToElement(findElement(By.xpath("//form[@id='ext-zonePanel-34']//div[@id='ext-kanbandataview-2']/div["+count1+"]//div[@class='kanbancard ']/div[2]/div[2]/ul/li[7]"))).build().perform();
				
				
				explicitWaitElementToBeClickable(findElement(By.xpath("//form[@id='ext-zonePanel-34']//div[@id='ext-kanbandataview-2']/div["+count1+"]//div[@class='kanbancard ']/div[2]/div[2]/ul/li[7]")));
				try {Thread.sleep(2000);}catch(InterruptedException ie) {}
				findElement(By.xpath("//form[@id='ext-zonePanel-34']//div[@id='ext-kanbandataview-2']/div["+count1+"]//div[@class='kanbancard ']/div[2]/div[2]/ul/li[7]")).click();
		...
		for(int i=31;i<=35; i++)
		{
			...
			if(i>=36)
			{
				...
				actions.moveToElement(findElement(By.xpath("//form[@id='ext-zonePanel-35']//div[@id='ext-kanbandataview-2']/div["+count2+"]//div[@class='kanbancard ']/div[2]/div[2]/ul/li[7]"))).build().perform();
				
				try {Thread.sleep(2000);}catch(InterruptedException ie) {}
				
				explicitWaitElementToBeClickable(findElement(By.xpath("//form[@id='ext-zonePanel-35']//div[@id='ext-kanbandataview-2']/div["+count2+"]//div[@class='kanbancard ']/div[2]/div[2]/ul/li[7]")));
				try {Thread.sleep(2000);}catch(InterruptedException ie) {}
				findElement(By.xpath("//form[@id='ext-zonePanel-35']//div[@id='ext-kanbandataview-2']/div["+count2+"]//div[@class='kanbancard ']/div[2]/div[2]/ul/li[7]")).click();
		...
		for(int k=41; k<=45; k++)
		{
			...
			if(k>=46)
			{
				...
				actions.moveToElement(findElement(By.xpath("//form[@id='ext-zonePanel-36']//div[@id='ext-kanbandataview-2']/div["+count3+"]//div[@class='kanbancard ']/div[2]/div[2]/ul/li[7]"))).build().perform();
				
				try {Thread.sleep(2000);}catch(InterruptedException ie) {}
				
				explicitWaitElementToBeClickable(findElement(By.xpath("//form[@id='ext-zonePanel-36']//div[@id='ext-kanbandataview-2']/div["+count3+"]//div[@class='kanbancard ']/div[2]/div[2]/ul/li[7]")));
				try {Thread.sleep(2000);}catch(InterruptedException ie) {}
				findElement(By.xpath("//form[@id='ext-zonePanel-36']//div[@id='ext-kanbandataview-2']/div["+count3+"]//div[@class='kanbancard ']/div[2]/div[2]/ul/li[7]")).click();
